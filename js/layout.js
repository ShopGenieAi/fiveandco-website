...
<nav class="nav" id="nav">
  <a href="index.html" class="nav-logo-img">
    <img src="images/logo_transparent.png" alt="Five&Co — Digital Design & Web Strategy" style="height:64px;width:auto;display:block;object-fit:contain;">
  </a>
...
<footer style="background:#111;border-top:1px solid rgba(212,175,55,0.2);padding:3rem 5%;">
  <div style="max-width:1200px;margin:0 auto;display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:1.5rem;">
    <div>
      <img src="images/logo_transparent.png" alt="Five&Co" style="height:90px;width:auto;display:block;object-fit:contain;">
    </div>
